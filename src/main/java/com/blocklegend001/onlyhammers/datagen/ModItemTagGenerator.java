...
public class ModItemTagGenerator extends ItemTagsProvider {
    ...
    protected void addTags(HolderLookup.Provider provider) {
        ...
        tag(ModTags.Items.LAPIS_HAMMERS_REPAIRS).add(Items.LAPIS_LAZULI);
        tag(ModTags.Items.REDSTONE_HAMMERS_REPAIRS).add(Items.REDSTONE);
        tag(ModTags.Items.EMERALD_HAMMERS_REPAIRS).add(Items.EMERALD);
        tag(ModTags.Items.OBSIDIAN_HAMMERS_REPAIRS).add(Items.OBSIDIAN);
