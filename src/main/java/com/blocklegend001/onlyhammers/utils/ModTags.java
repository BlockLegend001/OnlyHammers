...
public class ModTags {
    public static class Items {
        ...
        public static final TagKey<Item> LAPIS_HAMMERS_REPAIRS = tag("lapis_hammers_repairs");
        public static final TagKey<Item> REDSTONE_HAMMERS_REPAIRS = tag("redstone_hammers_repairs");
        public static final TagKey<Item> EMERALD_HAMMERS_REPAIRS = tag("emerald_hammers_repairs");
        public static final TagKey<Item> OBSIDIAN_HAMMERS_REPAIRS = tag("obsidian_hammers_repairs");
